    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/bookings/flights/search", "/bookings/hotels/search").permitAll()
                .requestMatchers(HttpMethod.GET, "/trips/public/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/trips/shared/**").permitAll()
                .requestMatchers("/export/public/**", "/export/trips/**").permitAll()
                .requestMatchers("/budget/rates/**").permitAll()
                .requestMatchers("/weather/**").permitAll()
                .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll()
                .requestMatchers("/actuator/**", "/h2-console/**").permitAll()
                .requestMatchers("/ws-travel/**").permitAll()
